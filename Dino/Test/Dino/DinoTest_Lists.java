...
class DinoTest_Lists {
    ...
    {
        testFile = new Dino("Test_Resources/T1_dialogueOnly.dino");
    ...
    void T2_listOnly()
    {
        testFile = new Dino("Test_Resources/T2_listOnly.dino");
        String retVal = testFile.getDialogue();
        assertEquals(expected, retVal,
    ...
    {
        testFile = new Dino("Test_Resources/T8_2ListsNoSpace.txt");
        String retVal = testFile.getDialogue();
        assertEquals(expected, retVal,
