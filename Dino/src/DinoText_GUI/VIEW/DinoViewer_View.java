...
public class DinoViewer_View extends JFrame{
    ...
    // getters
    public String getJtextField_Input(){ return JTextField_Input.getText();}
    public String getJLabel_Filename(){ return JLabel_Filename.getText();}
    public String getJTextPane_Output(){ return JTextPane_Output.getText();}
